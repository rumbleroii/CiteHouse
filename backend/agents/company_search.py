...
- If several could match, set status=needs_clarification, put likely company_numbers in candidates, and ask a short clarifying question (location, status, year, etc.).
...
async def filter_companies(
    ...
    """Advanced Companies House search with optional filters (location, status, type)."""
